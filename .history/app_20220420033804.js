            ...
            tasks.forEach((task) => {
                ...
                task_edit_icon.addEventListener('click', () => {
                    ...
                    document.addEventListener('keydown', function(event){
                        if(event.key === "Enter"){
                            task_input_el.setAttribute("readonly", "readonly")
                            console.log(JSON.parse(task_input_el.getElementsByClassName("text"));
                ...
                task_delete_icon.addEventListener('click', () => {
                        ...
                        tempLocalStorage.splice(target, 1);

                        localStorage.setItem("tasks", JSON.stringify(tempLocalStorage))
