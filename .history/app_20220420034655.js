        ...
        try {
            ...
            tasks.forEach((task) => {
                ...
                task_edit_icon.addEventListener('click', () => {
                    ...
                    // if (task_edit_icon.innerText.toLowerCase() == "edit") {
                    //     task_input_el.removeAttribute("readonly");
                    //     // need to look into .focus
                    //     task_input_el.focus();
                    //     task_edit_el.innerText = "Save";
                ...
                task_delete_icon.addEventListener('click', () => {
                        var tempLocalStorage2 = JSON.parse(localStorage.getItem("tasks"))
                        // var target;

                        // for (var i = 0; i < tempLocalStorage.length; i++) {
                        //     var item = tempLocalStorage[i];
                        //     if (item.id == task_el.id) {
                        //         target = i;
                        //     }
                        // }

                        // getIndexById(task_el.id);
                        tempLocalStorage2.splice(getIndexById(task_el.id), 1);

                        localStorage.setItem("tasks", JSON.stringify(tempLocalStorage2))
